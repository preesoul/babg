...
// 능력 설명 (CSV 기반)
var ABILITY_DESCS = {
  juri:     {type:'뒤끝',desc:'<팬짱>을 부릅니다.\n팬짱은 게임 내 주리의 사망 수만큼 강화됩니다.',skin:'웨이트리스 주리: 사망 수 x2',skinDesc:'뒤끝: <팬짱>을 부릅니다.\n팬짱은 게임 내 주리의 사망 수<span style="color:#ffd700;font-weight:700">x2</span>만큼 강화됩니다.'},
  chinatsu: {type:'뒤끝',desc:'아군 무작위 1인에게 보호막을 부여합니다.',skin:'온천 치나츠: 아군 두 명에게 부여',skinDesc:'뒤끝: 아군 무작위 <span style="color:#ffd700;font-weight:700">2인에게</span> 보호막을 부여합니다.'},
  kayoko:   {type:'개전',desc:'상대방의 1~5번째 학생 배치를 역순으로 뒤집습니다.',skin:'드레스 카요코: 동일'},
  midori:   {type:'개전',desc:'<모모이> 수만큼 +1/+1',skin:'메이드 미도리: 수×+2/+2\n둘 다 메이드: 수×+4/+4',skinDesc:'개전: <모모이> 수만큼 <span style="color:#ffd700;font-weight:700">+2/+2</span>'},
  momoi:    {type:'개전',desc:'<미도리> 수만큼 +1/+1',skin:'메이드 모모이: 수×+2/+2\n둘 다 메이드: 수×+4/+4',skinDesc:'개전: <미도리> 수만큼 <span style="color:#ffd700;font-weight:700">+2/+2</span>'},
  mari:     {type:'개전',desc:'아군 전체 +2/+1',skin:'아이돌 마리: +3/+3',skinDesc:'개전: 아군 전체 <span style="color:#ffd700;font-weight:700">+3/+3</span>'},
  aru:      {type:'선제',desc:'공격 시, 5~6티어 학생에게는 공격력이 2배가 됩니다.\n1~2티어 학생에게는 공격력이 절반(내림)이 됩니다.',skin:'드레스 아루: 3배',skinDesc:'선제: 공격 시, 5~6티어 학생에게는 공격력이 <span style="color:#ffd700;font-weight:700">3배</span>가 됩니다.\n1~2티어 학생에게는 공격력이 절반(내림)이 됩니다.'},
  kasumi:   {type:'개전 / 뒤끝',desc:'개전: 가장 체력이 높은 적을 공격 대상으로 지정합니다.\n뒤끝: 자신을 쓰러뜨린 상대를 쓰러뜨립니다.',skin:'수영복 카스미: 동일'},
  iroha:    {type:'첫인사',desc:'<토라마루>로 교체됩니다. (토라마루: 5/1)\n토라마루 파괴 시 이로하로 돌아옵니다.',skin:'수영복 이로하: 토라마루 10/2\n토라마루 파괴 시 이로하로 돌아옵니다.',skinDesc:'첫인사: <토라마루>로 교체됩니다. (토라마루: <span style="color:#ffd700;font-weight:700">10/2</span>)\n토라마루 파괴 시 이로하로 돌아옵니다.'},
  himari:   {type:'첫인사',desc:'아군 밀레니엄 학생들 +3/+3',skin:'임전 히마리: +6/+6',skinDesc:'첫인사: 아군 밀레니엄 학생들에게 <span style="color:#ffd700;font-weight:700">+6/+6</span>을 부여합니다.'},
  rio:      {type:'개전',desc:'아군의 모든 첫인사를 발동합니다.\n전투가 끝나면 원래대로 돌아갑니다.',skin:'임전 리오: 두 번 발동',skinDesc:'개전: 아군의 모든 첫인사를 <span style="color:#ffd700;font-weight:700">두 번</span> 발동합니다.\n전투가 끝나면 원래대로 돌아갑니다.'},
  ako:      {type:'뒤끝',desc:'이번 전투에서 게헨나 학생들 +4/+4',skin:'드레스 아코: +8/+8',skinDesc:'뒤끝: 이번 전투에서 게헨나 학생들에게 <span style="color:#ffd700;font-weight:700">+8/+8</span>을 부여합니다.'},
  kazusa:   {type:'뒤끝',desc:'<카스팔루스>로 교체됩니다. (1/1, 독사굴)',skin:'밴드 카즈사: 부활 추가',skinDesc:'<span style="color:#ffd700;font-weight:700">부활</span>, 뒤끝: <카스팔루스>로 교체됩니다.\n(카스팔루그: 1/1, 독사굴)'},
  hifumi:   {type:'뒤끝',desc:'<페로로님>을 소환합니다. (2/1)\n페로로님이 적을 쓰러뜨리면 히후미로 교체됩니다.',skin:'수영복 히후미: 페로로님 4/2',skinDesc:'뒤끝: <페로로님>을 소환합니다. (페로로님: <span style="color:#ffd700;font-weight:700">4/2</span>)\n페로로님이 적을 쓰러뜨리면 히후미로 교체됩니다.'},
  azusa:    {type:'뒤끝',desc:'적 전체에게 -2의 데미지를 줍니다.',skin:'수영복 아즈사: -4 데미지',skinDesc:'뒤끝: 적 전체에게 <span style="color:#ffd700;font-weight:700">-4</span>의 데미지를 줍니다.'},
  sakurako: {type:'개전',desc:'아군 트리니티 학생들의 개전을 한 번 더 발동합니다.',skin:'아이돌 사쿠라코: 두 번 더 발동',skinDesc:'개전: 아군 트리니티 학생들의 개전을 <span style="color:#ffd700;font-weight:700">두 번</span> 더 발동합니다.'},
  tsurugi:  {type:'개전',desc:'자신에게 +10/+10',skin:'수영복 츠루기: +20/+20',skinDesc:'개전: 자신에게 <span style="color:#ffd700;font-weight:700">+20/+20</span>을 부여합니다.'},
  mine:     {type:'개전',desc:'아군의 모든 도발을 제거합니다.',skin:'아이돌 미네: 동일'},
  toki:     {type:'버티기',desc:'<아비 에슈흐>를 소환합니다.\n스케쥴 레벨×2의 공/체를 가집니다.',skin:'메이드 토키: 스케쥴 레벨×4',skinDesc:'버티기: <아비 에슈흐>를 소환합니다.\n스케쥴 레벨<span style="color:#ffd700;font-weight:700">×4</span>의 공/체를 가집니다.'},
  neru:     {type:'버티기',desc:'기본 능력 중 하나를 무작위로 얻습니다.',skin:'바니걸 네루: 두 가지를 무작위로 얻습니다.',skinDesc:'버티기: 기본 능력 중 <span style="color:#ffd700;font-weight:700">두 가지</span>를 무작위로 얻습니다.'},
  toramaru: {type:'뒤끝',desc:'원래의 이로하를 소환합니다.',skin:'황금 토라마루: 수영복 이로하 소환'},
  ui:       {type:'선제',desc:'상대의 모든 능력을 삭제합니다.',skin:'수영복 우이: 상대 바로 옆 한 명도 함께 삭제',skinDesc:'선제: <span style="color:#ffd700;font-weight:700">상대와 상대 바로 옆</span> 한 명의 모든 능력을 삭제합니다.'},
  junko:    {type:'자폭 / 뒤끝',desc:'자폭: 공격력과 체력을 합쳐 공격 후 쓰러집니다.\n뒤끝: <당고>를 소환합니다. (1/1)',skin:'새해 준코: 당고 2개 소환',skinDesc:'뒤끝: <당고>를 <span style="color:#ffd700;font-weight:700">2개</span> 소환합니다. (당고 1/1)'},
  eimi:     {type:'패시브',desc:'밀레니엄의 모든 토큰 소환 시\n스케쥴 레벨×2의 공/체를 추가합니다.',skin:'수영복 에이미: 스케쥴 레벨×4',skinDesc:'패시브: 밀레니엄의 모든 토큰 소환 시,\n스케쥴 레벨<span style="color:#ffd700;font-weight:700">×4</span>의 공/체를 추가합니다.'},
  sena:     {type:'패시브',desc:'관통의 초과 데미지만큼 아군 전체 HP를 회복합니다.\n(전투당 1회)',skin:'사복 세나: 초과 데미지 x2 회복',skinDesc:'패시브: 관통의 초과 데미지 <span style="color:#ffd700;font-weight:700">x2</span>만큼 아군 전체 HP를 회복합니다.\n(전투당 1회)'},
  satsuki:  {type:'뒤끝',desc:'자신을 죽인 상대를 1턴간 빼앗습니다.',skin:'수영복 사츠키: 2턴간 빼앗음',skinDesc:'뒤끝: 자신을 죽인 상대를 <span style="color:#ffd700;font-weight:700">2턴간</span> 빼앗습니다.'},
  makoto:   {type:'개전',desc:'<비행선>으로 교체됩니다.\n비행선: 아군 수×2 공격력/체력, 자폭',skin:'수영복 마코토: 아군 수×4\n비행선 자폭 후 파마머리 마코토 소환',skinDesc:'개전: <비행선>으로 교체됩니다.\n(비행선: 아군 수<span style="color:#ffd700;font-weight:700">×4</span> 공격력/체력, 자폭)'},
  hibiki:   {type:'개전',desc:'적 전체 -1/-1',skin:'치어리더 히비키: -2/-2',skinDesc:'개전: 적 전체에게 <span style="color:#ffd700;font-weight:700">-2/-2</span>을 부여합니다.'},
  yuzu:     {type:'뒤끝',desc:'쓰러진 아군 수×2 공/체의\n<아방가르드군>을 소환합니다.',skin:'메이드 유즈: 쓰러진 아군 수×4',skinDesc:'뒤끝: 쓰러진 아군 수<span style="color:#ffd700;font-weight:700">×4</span> 공/체의\n<아방가르드군>을 소환합니다.'},
  noa:      {type:'버티기',desc:'상대의 능력(키워드)을 복사합니다.\n아군 유우카에게도 부여합니다.',skin:'파자마 노아: 아군 모든 밀레니엄 학생들에게도 부여',skinDesc:'버티기: 상대의 능력(키워드)을 복사합니다.\n<span style="color:#ffd700;font-weight:700">아군 모든 밀레니엄 학생들에게도</span> 부여합니다.'},
  utaha:    {type:'선제',desc:'<천둥이>(8/2, 보호막)를 소환해 먼저 공격시킵니다.\n천둥이가 적을 처치하면 우타하는 공격하지 않습니다.',skin:'치어리더 우타하: 천둥이 두 번 소환',skinDesc:'선제: <천둥이>(8/2, 보호막)를 소환해 먼저 공격시킵니다.\n<span style="color:#ffd700;font-weight:700">두 번 시행합니다.</span>\n천둥이가 적을 처치하면 우타하는 공격하지 않습니다.'},
  mashiro:  {type:'저격',desc:'',skin:''},
  hinata:   {type:'선제',desc:'한 번에 2~5회 공격합니다.',skin:'수영복 히나타: 4~10회',skinDesc:'선제: 한 번에 <span style="color:#ffd700;font-weight:700">4~10회</span> 공격합니다.'},
  airship:  {type:'뒤끝',desc:'<파마머리 마코토>를 소환합니다.',skin:''},
  // 7성 히든
  gehenna_prefect:        {type:'패시브',desc:'샬레의 히나, 이오리, 아코, 치나츠를 흡수하며 등장합니다.\n기본 능력치 20/20에 흡수한 학생들 각각의 공격력 합, 체력 합을 각각 더합니다.',skin:''},
  gehenna_pandemonium:    {type:'패시브 / 첫인사 / 뒤끝',desc:'샬레의 마코토, 사츠키, 이로하, 이부키, 치아키를 흡수하며 등장합니다.\n기본 능력치 10/10에 흡수한 학생들 각각의 공격력 합, 체력 합을 각각 더합니다.\n첫인사: 황금 비행선(도발)과 황금 토라마루(도발)를 소환합니다.\n뒤끝: 상대 무작위 2인을 이번 전투동안 빼앗습니다.',skin:''},
  gehenna_traingun:       {type:'패시브 / 개전 / 뒤끝',desc:'공격하지 않습니다.\n개전: 상대 전체에 6의 광역 데미지.\n살아남은 전투마다 개전 발동 횟수가 증가합니다.\n뒤끝: 이번 게임에서 완전히 사라집니다.',skin:''},
  trinity_mika:           {type:'패시브',desc:'능력/효과로 인한 데미지와 쓰러짐에 면역입니다.\n전투 데미지로만 쓰러뜨릴 수 있습니다.',skin:''},
  trinity_nagisa:         {type:'개전',desc:'마리(아이돌), 사쿠라코(아이돌), 미네(아이돌)에게\n+10/+10를 부여합니다.',skin:''},
  trinity_seia:           {type:'패시브 / 뒤끝',desc:'공격하지 않습니다.\n아군 트리니티 학생들은 방어 시 전투 데미지를 받지 않습니다.\n뒤끝: 아군 전체 능력이 삭제됩니다.\n세이아가 이번 게임에서 완전히 사라집니다.',skin:''},
  millennium_nameless:    {type:'개전',desc:'자신을 파괴합니다.\n공격력+체력 총합으로 적 왼쪽부터 순차 데미지.\n보호막은 0 소비로 벗깁니다.',skin:''},
  millennium_malkuth:     {type:'선제 / 패시브',desc:'선제: 스위퍼 2체를 소환해 먼저 공격시킵니다.\n(스위퍼: 10/10, 자폭공격)\n스위퍼로 적이 쓰러지면 말쿠트는 공격하지 않습니다.\n패시브: 모든 밀레니엄 학생의 소환 토큰이 스위퍼로 대체됩니다.',skin:''},
  millennium_death_momoi: {type:'패시브 / 선제',desc:'샬레의 모든 모모이를 흡수하며 등장합니다.\n기본 능력치 10/10에 흡수한 모모이들의 공격력 합, 체력 합을 각각 더합니다.\n선제: 적 스탯이 기본보다 높으면 부여 수치를 제거하고 공격합니다.',skin:''},
  sweeper:  {type:'자폭',desc:'',skin:''},
  // 백귀야행
  izuna:    {type:'첫인사',desc:'아군 전체 공격력 +1 (자신 포함)',skin:'수영복 이즈나: +1/+1',skinDesc:'첫인사: 아군 전체에게 <span style="color:#ffd700;font-weight:700">+1/+1</span> (자신 포함)'},
  tsukuyo:  {type:'첫인사',desc:'아군 전체 +1/+1 (자신 포함)',skin:'드레스 츠쿠요: +2/+2',skinDesc:'첫인사: 아군 전체에게 <span style="color:#ffd700;font-weight:700">+2/+2</span>을 부여합니다. (자신 포함)'},
  yukari:   {type:'선제',desc:'<계승전> 카운터를 1 쌓습니다. (최대 5)',skin:'수영복 유카리: 동일'},
  mimori:   {type:'버티기',desc:'이번 전투 동안 상대 전체 공격력 -1\n(공격력 0이면 공격하지 않습니다.)',skin:'수영복 미모리: -2',skinDesc:'버티기: 이번 전투 동안 상대 전체 공격력 <span style="color:#ffd700;font-weight:700">-2</span>\n(공격력 0이면 공격하지 않습니다.)'},
  renge:    {type:'선제',desc:'<계승전> 카운터를 1 쌓습니다. (최대 5)',skin:'수영복 렌게: 동일'},
  shizuko:  {type:'패시브',desc:'첫인사가 2회 발동합니다.',skin:'수영복 시즈코: 4회 발동',skinDesc:'패시브: 첫인사가 <span style="color:#ffd700;font-weight:700">4회</span> 발동합니다.'},
  tsubaki:  {type:'첫인사',desc:'아군 백귀야행 학생들 +2/+2 (본인 포함)',skin:'가이드 츠바키: +4/+4',skinDesc:'첫인사: 아군 백귀야행 학생들에게 <span style="color:#ffd700;font-weight:700">+4/+4</span>를 부여합니다. (본인 포함)'},
  kikyou:   {type:'선제',desc:'<계승전> 카운터를 1 쌓습니다. (최대 5)',skin:'수영복 키쿄: 동일'},
  chise:    {type:'패시브',desc:'공격한 상대의 능력 중\n무작위 1개를 이번 전투 동안 제거합니다.',skin:'수영복 치세: 무작위 2개 제거',skinDesc:'패시브: 공격한 상대의 능력 중\n무작위 <span style="color:#ffd700;font-weight:700">2개</span>를 이번 전투 동안 제거합니다.'},
  michiru:  {type:'첫인사',desc:'샬레의 다른 백귀야행 학생들이 가진\n모든 첫인사를 추가로 발동합니다.',skin:'드레스 미치루: 추가로 두 번 발동',skinDesc:'첫인사: 샬레의 다른 백귀야행 학생들이 가진\n모든 첫인사를 추가로 <span style="color:#ffd700;font-weight:700">두 번</span> 발동합니다.'},
  nagusa:   {type:'선제',desc:'2~5회 공격합니다.\n타격 1회당 <계승전> 카운터를 1 쌓습니다. (최대 5)',skin:'수영복 나구사: 동일'},
  wakamo:   {type:'선제 / 패시브',desc:'2~5회 공격합니다.\n타격 1회당 <호버크래프트> 카운터를 1 쌓습니다.\n패시브: 카운터 5개가 쌓이면 0으로 되돌리며 <호버크래프트>를 소환합니다.\n(호버크래프트: 10/10, 저격)',skin:'수영복 와카모: 4~10회 공격',skinDesc:'선제: <span style="color:#ffd700;font-weight:700">4~10회</span> 공격합니다.\n타격 1회당 <호버크래프트> 카운터를 1 쌓습니다.\n패시브: 카운터 5개가 쌓이면 0으로 되돌리며 <호버크래프트>를 소환합니다.\n(호버크래프트: 10/10, 저격)'},
  hovercraft:{type:'뒤끝',desc:'아군 와카모가 모두 쓰러진 상태라면\n와카모를 소환합니다.',skin:'황금 호버크래프트: 20/20\n와카모(수영복) 소환'},
  // 백귀야행 7성
  hkyk_saikyo:   {type:'히든',desc:'순수한 힘. 50/50 바닐라 스탯.',skin:''},
  hkyk_kuzunoha: {type:'개전',desc:'아군 백귀야행 학생 전체에게 독사굴을 부여합니다.\n이후 상대 전체의 독사굴을 제거합니다.',skin:''},
  hkyk_showdown: {type:'액션카드',desc:'유카리, 렌게, 키쿄, 나구사에게\n+10/+10과 보호막, 연사, 부활을 부여합니다.\n(수영복 포함)',skin:''},
  // 신규 7성
  gehenna_p68:            {type:'패시브 / 개전',desc:'샬레의 카요코, 무츠키, 하루카, 아루를 흡수하며 등장합니다.\n개전: 상대 배치 순서를 완전히 역순으로 변경합니다.\n도발을 무시하고, 가장 체력이 낮은 적을 공격 대상으로 정합니다.',skin:''},
  millennium_seminar:     {type:'패시브 / 개전',desc:'샬레의 유우카, 노아, 코유키, 리오를 흡수하며 등장합니다.\n개전: 상대 전체 능력 삭제 후 공/체를 뒤집습니다.\n삭제된 기본능력 중 최대 3개, 특수능력 중 최대 3개를 자신에게 복사합니다.',skin:''},
  millennium_cc:          {type:'패시브 / 뒤끝',desc:'샬레의 네루, 아스나, 아카네, 카린, 토키를 흡수하며 등장합니다.\n패시브: 코인 토스가 항상 성공합니다.\n뒤끝: 아비 에슈흐(스케쥴×8)를 소환합니다.',skin:''},
  trinity_makeup:         {type:'패시브',desc:'샬레의 히후미, 코하루, 하나코, 아즈사를 흡수하며 등장합니다.\n전투 승리 시 보충수업부가 생존해 있으면 상대 HP를 0으로 만듭니다.',skin:''},
  trinity_justice:        {type:'패시브 / 개전',desc:'샬레의 하스미, 츠루기, 마시로, 이치카를 흡수하며 등장합니다.\n개전: 자신의 공격력과 체력을 2배로 합니다.',skin:''},
  // ===== 신규 캐릭터 =====
  ibuki:    {type:'개전',desc:'아군 마코토, 치아키, 사츠키, 이로하에게\n+5/+5를 부여합니다.',skin:'수영복 이부키: +10/+10',skinDesc:'개전: 아군 마코토, 치아키, 사츠키, 이로하에게\n<span style="color:#ffd700;font-weight:700">+10/+10</span>을 부여합니다.'},
  chiaki:   {type:'저격',desc:'저격 공격. 반격을 받지 않습니다.',skin:'수영복 치아키: 동일'},
  koyuki:   {type:'선제',desc:'공격 대상의 공격력과 체력 수치를\n이번 전투 동안 뒤집습니다.',skin:'파자마 코유키: 동일'},
  akane:    {type:'개전',desc:'아군 네루, 카린, 아스나, 아카네, 토키에게\n"뒤끝: C4(5/5 자폭) 소환"을 부여합니다.\n(중복되지 않습니다.)',skin:'버니걸 아카네: 동일'},
  karin:    {type:'저격+관통',desc:'저격 공격 + 관통 공격.\n반격 없이 모든 적을 관통합니다.',skin:'버니걸 카린: 동일'},
  asuna:    {type:'패시브',desc:'우선권 코인토스에서, 아스나는 무조건 성공합니다.',skin:'버니걸 아스나: 동일'},
  koharu:   {type:'선제',desc:'공격 시, 10% 확률로 대상의 능력을 제거하고\n즉사시킵니다.',skin:'수영복 코하루: 확률 20%',skinDesc:'선제: 공격 시, <span style="color:#ffd700;font-weight:700">20%</span> 확률로 대상의 능력을 제거하고\n즉사시킵니다.'},
  hasumi:   {type:'패시브',desc:'전투당 한 번, 처음으로 쓰러뜨린 적의\n공격력과 체력을 흡수합니다.',skin:'수영복 하스미: 두 배로 흡수',skinDesc:'패시브: 전투당 한 번, 처음으로 쓰러뜨린 적의\n공격력과 체력을 <span style="color:#ffd700;font-weight:700">두 배로</span> 흡수합니다.'},
  suzumi:   {type:'패시브',desc:'자신을 공격한 적의 공격력을\n한 바퀴 동안 0으로 만듭니다.',skin:'마법소녀 스즈미: 이번 전투 동안',skinDesc:'패시브: 자신을 공격한 적의 공격력을\n<span style="color:#ffd700;font-weight:700">이번 전투 동안</span> 0으로 만듭니다.'},
  shimiko:  {type:'스킨 효과',desc:'기본: 바닐라 (효과 없음)\n황금: 보호막, 연사를 얻습니다.',skin:'악의 간부 시미코: 보호막, 연사'},
  mutsuki:  {type:'관통',desc:'관통 공격으로 적을 통과해 뒤의 적도 공격합니다.',skin:'새해 무츠키: 동일'},
  haruka:   {type:'선제',desc:'한 번에 1~2회 공격을 합니다.\n이번 전투에서 무츠키, 카요코, 아루를 공격한\n적을 공격할 시 5회 공격합니다.',skin:'새해 하루카: 2~5회 / 조건 시 10회',skinDesc:'선제: 한 번에 <span style="color:#ffd700;font-weight:700">2~5회</span> 공격을 합니다.\n이번 전투에서 무츠키, 카요코, 아루를 공격한\n적을 공격할 시 <span style="color:#ffd700;font-weight:700">10회</span> 공격합니다.'},
  // 총학생회
  haine:    {type:'패시브',desc:'팔면 아군 전체 +2/+2',skin:'인터뷰 하이네: +4/+4',skinDesc:'패시브: 팔면 아군 전체에 <span style="color:#ffd700;font-weight:700">+4/+4</span>를 부여합니다.'},
  momoka:   {type:'패시브',desc:'매 턴 추가 리롤이 1회 무료입니다.',skin:'승무원 모모카: 2회 무료',skinDesc:'패시브: 매 턴 추가 리롤이 <span style="color:#ffd700;font-weight:700">2회</span> 무료입니다.'},
  ayumu:    {type:'패시브',desc:'액션카드의 수치 증가에 +2/+2가 추가됩니다.',skin:'승무원 아유무: +4/+4 추가',skinDesc:'패시브: 액션카드의 수치 증가에 <span style="color:#ffd700;font-weight:700">+4/+4</span> 추가됩니다.'},
  aoi:      {type:'패시브',desc:'매 턴 (청휘석)+2를 추가로 얻습니다.',skin:'인터뷰 아오이: +4 추가',skinDesc:'패시브: 매 턴 (청휘석아이콘)<span style="color:#ffd700;font-weight:700">+4</span>를 추가로 얻습니다.'},
  kaya:     {type:'개전',desc:'아군 맨 왼쪽 학생을 쓰러뜨리고\n공격력과 체력을 흡수합니다. (가장 마지막에 발동)',skin:'쿠데타 카야: 두 배로 흡수',skinDesc:'개전: 아군 맨 왼쪽 학생을 쓰러뜨리고\n공격력과 체력을 <span style="color:#ffd700;font-weight:700">두 배로</span> 흡수합니다.\n(가장 마지막에 발동)'},
  lin:      {type:'패시브',desc:'아군의 뒤끝과 첫인사가\n한 번 더 발동합니다.',skin:'승무원 린: 두 번 더 발동',skinDesc:'패시브: 아군의 뒤끝과 첫인사가\n<span style="color:#ffd700;font-weight:700">두 번</span> 더 발동합니다.'},
  // ===== 스킨 전용 효과 =====
  yuuka:    {type:'스킨 효과',desc:'기본: 바닐라 (효과 없음)\n황금: 개전 - 자신에게 +2/+2',skin:'체육복 유우카: 개전 +2/+2',skinDesc:'<span style="color:#ffd700;font-weight:700">개전: 자신에게 +2/+2</span>'},
  arisu:    {type:'스킨 효과',desc:'기본: 관통\n황금: 관통이 삭제되고 광역으로 변경',skin:'메이드 아리스: 광역',skinDesc:'<span style="color:#ffd700;font-weight:700">광역</span>'},
  hina:     {type:'스킨 효과',desc:'기본: 광역\n황금: 광역이 삭제되고 보호막, 연사로 변경',skin:'드레스 히나: 보호막, 연사'},
};
...
function _doBC(m, p) {
  ...
  // ===== 백귀야행 첫인사 =====
    ...
    if(p.board.length<MAX_BOARD){
      var gAirship=makeToken('airship');gAirship.atk=14;gAirship.hp=14;gAirship.isSkin=true;gAirship.isToken=false;addKw(gAirship,'taunt');
      p.board.push(gAirship);
    }
    if(p.board.length<MAX_BOARD){
      var gTora=makeToken('toramaru');gTora.atk=10;gTora.hp=2;gTora.isSkin=true;gTora.isToken=false;addKw(gTora,'taunt');
      p.board.push(gTora);
    }
  }
...
function runBattle(boardA, boardB, startWithA, opts) {
  ...
  function checkSurvive(unit,side,log2,hitBy){
    ...
    if(unit.baseId==='toki'){
      ...
      else{ae=makeToken('abi_eshuh');var mult=unit.isSkin?4:2;ae.atk=tierLvl*mult;ae.hp=tierLvl*mult;ae.maxHp=ae.hp;}
