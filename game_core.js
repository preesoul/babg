...
function statColor(baseId,isSkin,type,current){
  ...
  if(current>base)return'color:#ffdd00;font-weight:900;font-size:1.5em';if(current<base)return'color:#ff4444;font-weight:900;font-size:1.5em';return'';
}
...
function miniCardHtml(m){
  ...
  return '<div class="'+cls+'"'+baseAttr+'>'+bgTag+sLogoTag+mIconHtml+'<div class="mini-inner"><div class="name">'+m.name+'</div>'+
    '<div class="mini-stats"><div class="mini-atk" style="'+statColor(m.baseId,m.isSkin,'atk',m.atk)+'">'+m.atk+'</div><div class="mini-hp" style="'+(m.maxHp?(m.hp>=m.maxHp?'color:#ffdd00;font-weight:900;font-size:1.5em':m.hp<m.maxHp?'color:#ff4444;font-weight:900;font-size:1.5em':''):statColor(m.baseId,m.isSkin,'hp',m.hp))+'">'+m.hp+'</div></div>'+
