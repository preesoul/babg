...
// 능력 설명 (CSV 기반)
var ABILITY_DESCS = {
  juri:     {type:'뒤끝',desc:'<팬짱>을 부릅니다.\n팬짱은 게임 내 주리의 사망 수만큼 강화됩니다.',gold:'웨이트리스 주리: 사망 수 x2',goldDesc:'뒤끝: <팬짱>을 부릅니다.\n팬짱은 게임 내 주리의 사망 수<span style="color:#ffd700;font-weight:700">x2</span>만큼 강화됩니다.'},
  chinatsu: {type:'뒤끝',desc:'아군 게헨나 학생 무작위 1인에게 보호막을 부여합니다.',gold:'온천 치나츠: 게헨나 학생 두 명에게 부여',goldDesc:'뒤끝: 아군 게헨나 학생 무작위 <span style="color:#ffd700;font-weight:700">2인에게</span> 보호막을 부여합니다.'},
  kayoko:   {type:'개전',desc:'상대방의 1~5번째 학생 배치를 역순으로 뒤집습니다.',gold:'드레스 카요코: 동일'},
  midori:   {type:'개전',desc:'<모모이> 수만큼 +1/+1',gold:'메이드 미도리: 수×+2/+2\n둘 다 메이드: 수×+4/+4',goldDesc:'개전: <모모이> 수만큼 <span style="color:#ffd700;font-weight:700">+2/+2</span>'},
  momoi:    {type:'개전',desc:'<미도리> 수만큼 +1/+1',gold:'메이드 모모이: 수×+2/+2\n둘 다 메이드: 수×+4/+4',goldDesc:'개전: <미도리> 수만큼 <span style="color:#ffd700;font-weight:700">+2/+2</span>'},
  mari:     {type:'개전',desc:'아군 트리니티 학생들 +2/+1',gold:'아이돌 마리: +3/+3',goldDesc:'개전: 아군 트리니티 학생들 <span style="color:#ffd700;font-weight:700">+3/+3</span>'},
  aru:      {type:'선제',desc:'공격 시, 5~6티어 학생에게는 공격력이 2배가 됩니다.\n1~2티어 학생에게는 공격력이 절반(내림)이 됩니다.',gold:'드레스 아루: 3배',goldDesc:'선제: 공격 시, 5~6티어 학생에게는 공격력이 <span style="color:#ffd700;font-weight:700">3배</span>가 됩니다.\n1~2티어 학생에게는 공격력이 절반(내림)이 됩니다.'},
  kasumi:   {type:'개전 / 뒤끝',desc:'개전: 가장 체력이 높은 적을 공격 대상으로 지정합니다.\n뒤끝: 자신을 쓰러뜨린 상대를 쓰러뜨립니다.',gold:'수영복 카스미: 동일'},
  iroha:    {type:'첫인사',desc:'<토라마루>로 교체됩니다. (토라마루: 5/1)\n토라마루 파괴 시 이로하로 돌아옵니다.',gold:'수영복 이로하: 토라마루 10/2\n토라마루 파괴 시 이로하로 돌아옵니다.',goldDesc:'첫인사: <토라마루>로 교체됩니다. (토라마루: <span style="color:#ffd700;font-weight:700">10/2</span>)\n토라마루 파괴 시 이로하로 돌아옵니다.'},
  ...
  eimi:     {type:'패시브',desc:'밀레니엄의 모든 토큰 소환 시\n스케쥴 레벨×2의 공/체를 추가합니다.',gold:'수영복 에이미: 스케쥴 레벨×4',goldDesc:'패시브: 밀레니엄의 모든 토큰 소환 시,\n스케쥴 레벨<span style="color:#ffd700;font-weight:700">×4</span>의 공/체를 추가합니다.'},
  sena:     {type:'패시브',desc:'관통의 초과 데미지만큼 아군 전체 HP를 회복합니다.\n(전투당 1회)',gold:'사복 세나: 초과 데미지 x2 회복',goldDesc:'패시브: 관통의 초과 데미지 <span style="color:#ffd700;font-weight:700">x2</span>만큼 아군 전체 HP를 회복합니다.\n(전투당 1회)'},
  satsuki:  {type:'뒤끝',desc:'자신을 죽인 상대를 1턴간 빼앗습니다.',gold:'수영복 사츠키: 2턴간 빼앗음',goldDesc:'뒤끝: 자신을 죽인 상대를 <span style="color:#ffd700;font-weight:700">2턴간</span> 빼앗습니다.'},
  ...
  // 백귀야행
  izuna:    {type:'첫인사',desc:'아군 백귀야행 학생들 공격력 +1 (자신 포함)',gold:'수영복 이즈나: +1/+1',goldDesc:'첫인사: 아군 백귀야행 학생들에게 <span style="color:#ffd700;font-weight:700">+1/+1</span> (자신 포함)'},
  tsukuyo:  {type:'첫인사',desc:'아군 백귀야행 학생들 +1/+1 (자신 포함)',gold:'드레스 츠쿠요: +2/+2',goldDesc:'첫인사: 아군 백귀야행 학생들에게 <span style="color:#ffd700;font-weight:700">+2/+2</span>을 부여합니다. (자신 포함)'},
  ...
  koharu:   {type:'선제',desc:'공격 시, 10% 확률로 대상의 능력을 제거하고\n즉사시킵니다.',gold:'수영복 코하루: 확률 20%',goldDesc:'선제: 공격 시, <span style="color:#ffd700;font-weight:700">20%</span> 확률로 대상의 능력을 제거하고\n즉사시킵니다.'},
  hasumi:   {type:'패시브',desc:'전투당 한 번, 처음으로 쓰러뜨린 적의\n공격력과 체력을 흡수합니다.',gold:'수영복 하스미: 두 배로 흡수',goldDesc:'패시브: 전투당 한 번, 처음으로 쓰러뜨린 적의\n공격력과 체력을 <span style="color:#ffd700;font-weight:700">두 배로</span> 흡수합니다.'},
  suzumi:   {type:'패시브',desc:'자신을 공격한 적의 공격력을\n한 바퀴 동안 0으로 만듭니다.',gold:'마법소녀 스즈미: 이번 전투 동안',goldDesc:'패시브: 자신을 공격한 적의 공격력을\n<span style="color:#ffd700;font-weight:700">이번 전투 동안</span> 0으로 만듭니다.'},
  shimiko:  {type:'황금 효과',desc:'기본: 바닐라 (효과 없음)\n황금: 보호막, 연사를 얻습니다.',gold:'악의 간부 시미코: 보호막, 연사'},
  mutsuki:  {type:'관통',desc:'관통 공격으로 적을 통과해 뒤의 적도 공격합니다.',gold:'새해 무츠키: 동일'},
  haruka:   {type:'선제',desc:'한 번에 1~2회 공격을 합니다.\n이번 전투에서 무츠키, 카요코, 아루를 공격한\n적을 공격할 시 5회 공격합니다.',gold:'새해 하루카: 2~5회 / 조건 시 10회',goldDesc:'선제: 한 번에 <span style="color:#ffd700;font-weight:700">2~5회</span> 공격을 합니다.\n이번 전투에서 무츠키, 카요코, 아루를 공격한\n적을 공격할 시 <span style="color:#ffd700;font-weight:700">10회</span> 공격합니다.'},
  // 총학생회
  haine:    {type:'패시브',desc:'팔면 아군 전체 +2/+2',gold:'인터뷰 하이네: +4/+4',goldDesc:'패시브: 팔면 아군 전체에 <span style="color:#ffd700;font-weight:700">+4/+4</span>를 부여합니다.'},
  momoka:   {type:'패시브',desc:'매 턴 추가 리롤이 1회 무료입니다.',gold:'승무원 모모카: 2회 무료',goldDesc:'패시브: 매 턴 추가 리롤이 <span style="color:#ffd700;font-weight:700">2회</span> 무료입니다.'},
  ayumu:    {type:'패시브',desc:'액션카드의 수치 증가에 +2/+2가 추가됩니다.',gold:'승무원 아유무: +4/+4 추가',goldDesc:'패시브: 액션카드의 수치 증가에 <span style="color:#ffd700;font-weight:700">+4/+4</span> 추가됩니다.'},
  aoi:      {type:'패시브',desc:'매 턴 (청휘석)+2를 추가로 얻습니다.',gold:'인터뷰 아오이: +4 추가',goldDesc:'패시브: 매 턴 (청휘석아이콘)<span style="color:#ffd700;font-weight:700">+4</span>를 추가로 얻습니다.'},
  kaya:     {type:'개전',desc:'아군 맨 왼쪽 학생을 쓰러뜨리고\n공격력과 체력을 흡수합니다. (가장 마지막에 발동)',gold:'쿠데타 카야: 두 배로 흡수',goldDesc:'개전: 아군 맨 왼쪽 학생을 쓰러뜨리고\n공격력과 체력을 <span style="color:#ffd700;font-weight:700">두 배로</span> 흡수합니다.\n(가장 마지막에 발동)'},
  lin:      {type:'패시브',desc:'아군의 뒤끝과 첫인사가\n한 번 더 발동합니다.',gold:'승무원 린: 두 번 더 발동',goldDesc:'패시브: 아군의 뒤끝과 첫인사가\n<span style="color:#ffd700;font-weight:700">두 번</span> 더 발동합니다.'},
  // ===== 스킨 전용 효과 =====
  yuuka:    {type:'황금 효과',desc:'기본: 바닐라 (효과 없음)\n황금: 개전 - 자신에게 +2/+2',gold:'체육복 유우카: 개전 +2/+2',goldDesc:'<span style="color:#ffd700;font-weight:700">개전: 자신에게 +2/+2</span>'},
  arisu:    {type:'황금 효과',desc:'기본: 관통\n황금: 관통이 삭제되고 광역으로 변경',gold:'메이드 아리스: 광역',goldDesc:'<span style="color:#ffd700;font-weight:700">광역</span>'},
  hina:     {type:'황금 효과',desc:'기본: 광역\n황금: 광역이 삭제되고 보호막, 연사로 변경',gold:'드레스 히나: 보호막, 연사'},
};
...
function triggerSOC(u, mySide, otherSide, log) {
  ...
  // ===== 7성 히든 개전 =====
    ...
    log.push({cls:'soc',text:'[개전] '+u.name+': 아군 백귀야행 전체 독사굴! 상대 독사굴 제거!'});
  }
