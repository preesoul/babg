...
var KW_LABELS = {taunt:'도발',shield:'보호막',cleave:'광역',reborn:'환생',windfury:'질풍',poison:'독성',pierce:'관통',survive:'생존',preemptive:'선제',ranged:'원거리',multistrike:'연격',selfdestruct:'자폭',invincible:'무적'};
var KW_DESCS = {
...
var ABILITY_DESCS = {
  ...
  chinatsu: {type:'뒤끝',desc:'아군 게헨나 학생 무작위 1인에게 보호막을 부여합니다.',gold:'온천 치나츠: 게헨나 학생 두 명에게 부여'},
  ...
  mari:     {type:'개전',desc:'아군 트리니티 학생들 +2/+1',gold:'아이돌 마리: +3/+3'},
  aru:      {type:'선제',desc:'공격 시, 5~6티어 학생에게는 공격력이 2배가 됩니다.\n1~2티어 학생에게는 공격력이 절반(내림)이 됩니다.',gold:'드레스 아루: 3배'},
  kasumi:   {type:'개전 / 뒤끝',desc:'개전: 가장 체력이 높은 적을 공격 대상으로 지정합니다.\n뒤끝: 자신을 쓰러뜨린 상대를 쓰러뜨립니다.',gold:''},
  iroha:    {type:'첫인사',desc:'<토라마루>로 교체됩니다. (5/1)',gold:'수영복 이로하: 토라마루 10/2\n토라마루 파괴 시 이로하 귀환'},
  himari:   {type:'첫인사',desc:'아군 밀레니엄 학생들 +3/+3',gold:'임전 히마리: +6/+6'},
  rio:      {type:'개전',desc:'아군의 모든 첫인사를 발동합니다.\n전투가 끝나면 원래대로 돌아갑니다.',gold:'임전 리오: 두 번 발동'},
  ako:      {type:'뒤끝',desc:'이번 전투에서 게헨나 학생들 +4/+4',gold:'드레스 아코: +8/+8'},
  kazusa:   {type:'뒤끝',desc:'<카스팔루스>로 교체됩니다. (1/1, 독성)',gold:'밴드 카즈사: 환생 추가'},
  hifumi:   {type:'뒤끝',desc:'<페로로님>을 소환합니다. (2/1)\n페로로님이 적을 쓰러뜨리면 히후미로 교체됩니다.',gold:'수영복 히후미: 페로로님 4/2'},
  azusa:    {type:'뒤끝',desc:'적 전체에게 -2의 데미지를 줍니다.',gold:'수영복 아즈사: -4 데미지'},
  sakurako: {type:'개전',desc:'아군 트리니티 학생들의 개전을 한 번 더 발동합니다.',gold:'아이돌 사쿠라코: 두 번 더 발동'},
  tsurugi:  {type:'개전',desc:'자신에게 +10/+10',gold:'수영복 츠루기: +20/+20'},
  mine:     {type:'개전',desc:'아군의 모든 도발을 제거합니다.',gold:''},
  toki:     {type:'생존',desc:'<아비 에슈흐>를 소환합니다.\n스케쥴 레벨×2의 공/체를 가집니다.',gold:'메이드 토키: 스케쥴 레벨×4'},
  neru:     {type:'생존',desc:'기본 능력 중 하나를 무작위로 얻습니다.',gold:'바니걸 네루: 두 가지를 무작위로 얻습니다.'},
  toramaru: {type:'뒤끝',desc:'원래의 이로하를 소환합니다.',gold:'황금 토라마루: 수영복 이로하 소환'},
  ui:       {type:'선제',desc:'상대의 모든 능력을 삭제합니다.',gold:'수영복 우이: 상대 바로 옆 한 명도 함께 삭제'},
  junko:    {type:'자폭 / 뒤끝',desc:'자폭: 공격력과 체력을 합쳐 공격 후 쓰러집니다.\n뒤끝: <당고>를 소환합니다. (1/1)',gold:'황금 준코: 당고 2개 소환'},
  eimi:     {type:'패시브',desc:'밀레니엄의 모든 토큰 소환 시\n스케쥴 레벨×2의 공/체를 추가합니다.',gold:'수영복 에이미: 스케쥴 레벨×4'},
  sena:     {type:'패시브',desc:'관통의 초과 데미지만큼 아군 전체 HP를 회복합니다.\n(전투당 1회)',gold:'사복 세나: 초과 데미지 x2 회복'},
  satsuki:  {type:'뒤끝',desc:'자신을 죽인 상대를 1턴간 빼앗습니다.',gold:'수영복 사츠키: 2턴간 빼앗음'},
  ...
  noa:      {type:'생존',desc:'상대의 능력(키워드)을 복사합니다.\n아군 유우카에게도 부여합니다.',gold:'파자마 노아: 아군 모든 밀레니엄 학생들에게도 부여'},
  ...
  gehenna_pandemonium:    {type:'패시브 / 첫인사 / 뒤끝',desc:'샬레의 마코토, 사츠키, 이로하, 이부키, 치아키를 흡수하며 등장합니다.\n기본 능력치 10/10에 흡수한 학생들 각각의 공격력 합, 체력 합을 각각 더합니다.\n첫인사: 황금 비행선(도발)과 황금 토라마루(도발)를 소환합니다.\n뒤끝: 상대 무작위 2인을 이번 전투동안 빼앗습니다.',gold:''},
  gehenna_traingun:       {type:'패시브 / 개전 / 뒤끝',desc:'공격하지 않습니다.\n개전: 상대 전체에 6의 광역 데미지.\n살아남은 전투마다 개전 발동 횟수가 증가합니다.\n뒤끝: 이번 게임에서 완전히 사라집니다.',gold:''},
  ...
  trinity_seia:           {type:'패시브 / 뒤끝',desc:'공격하지 않습니다.\n아군 트리니티 학생들은 방어 시 전투 데미지를 받지 않습니다.\n뒤끝: 아군 전체 능력이 삭제됩니다.\n세이아가 이번 게임에서 완전히 사라집니다.',gold:''},
  millennium_nameless:    {type:'개전',desc:'자신을 파괴합니다.\n공격력+체력 총합으로 적 왼쪽부터 순차 데미지.\n보호막은 0 소비로 벗깁니다.',gold:''},
  millennium_malkuth:     {type:'선제 / 패시브',desc:'선제: 스위퍼 2체를 소환해 먼저 공격시킵니다.\n(스위퍼: 10/10, 자폭공격)\n스위퍼로 적이 쓰러지면 말쿠트는 공격하지 않습니다.\n패시브: 모든 밀레니엄 학생의 소환 토큰이 스위퍼로 대체됩니다.',gold:''},
  millennium_death_momoi: {type:'패시브 / 선제',desc:'샬레의 모든 모모이를 흡수하며 등장합니다.\n기본 능력치 10/10에 흡수한 모모이들의 공격력 합, 체력 합을 각각 더합니다.\n선제: 적 스탯이 기본보다 높으면 부여 수치를 제거하고 공격합니다.',gold:''},
  sweeper:  {type:'자폭',desc:'',gold:''},
  // 백귀야행
  izuna:    {type:'첫인사',desc:'아군 백귀야행 학생들 공격력 +1 (자신 포함)',gold:'수영복 이즈나: +1/+1'},
  tsukuyo:  {type:'첫인사',desc:'아군 백귀야행 학생들 +1/+1 (자신 포함)',gold:'드레스 츠쿠요: +2/+2'},
  ...
  momoka:   {type:'패시브',desc:'매 턴 추가 리롤이 1회 무료입니다.',gold:'승무원 모모카: 2회 무료'},
  ayumu:    {type:'패시브',desc:'액션카드의 수치 증가에 +2/+2가 추가됩니다.',gold:'승무원 아유무: +4/+4 추가'},
  aoi:      {type:'패시브',desc:'매 턴 (청휘석)+2를 추가로 얻습니다.',gold:'인터뷰 아오이: +4 추가'},
  kaya:     {type:'개전',desc:'아군 맨 왼쪽 학생을 쓰러뜨리고\n공격력과 체력을 흡수합니다. (가장 마지막에 발동)',gold:'쿠데타 카야: 두 배로 흡수'},
  lin:      {type:'패시브',desc:'아군의 뒤끝과 첫인사가\n한 번 더 발동합니다.',gold:'승무원 린: 두 번 더 발동'},
  // ===== 스킨 전용 효과 =====
  yuuka:    {type:'황금 효과',desc:'기본: 바닐라 (효과 없음)\n황금: 개전 - 자신에게 +2/+2',gold:'체육복 유우카: 개전 +2/+2'},
  arisu:    {type:'황금 효과',desc:'기본: 관통\n황금: 관통이 삭제되고 광역으로 변경',gold:'메이드 아리스: 광역'},
  hina:     {type:'황금 효과',desc:'기본: 광역\n황금: 광역이 삭제되고 보호막, 질풍으로 변경',gold:'드레스 히나: 보호막, 질풍'},
};
...
function triggerSOC(u, mySide, otherSide, log) {
  ...
  if(id==='kayoko'){
    ...
    log.push({cls:'soc',text:'[개전] '+u.name+': 아군 첫인사 발동!'+(u.golden?' (2회)':'')});
  }
  else if(id==='mine'){
    for(var i=0;i<mySide.length;i++){
...
function _doDR(unit, mySide, otherSide, log) {
  ...
  if(id==='juri'){
    ...
    mySide.push(cp);
    log.push({cls:'soc',text:'[뒤끝] 카스팔루스 소환! ('+atk+'/'+hp2+', 독성)'});
  }
  else if(id==='hifumi'){
    if(countAlive(mySide)>=BATTLE_MAX) return;
