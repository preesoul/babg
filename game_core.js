...
function statColor(baseId,isSkin,type,current){
  ...
  if(current>base)return'color:#f0ff44;font-weight:900';if(current<base)return'color:#ff4444;font-weight:900';return'';
}
...
function miniCardHtml(m){
  ...
  return '<div class="'+cls+'"'+baseAttr+'>'+bgTag+sLogoTag+mIconHtml+'<div class="mini-inner"><div class="name">'+m.name+'</div>'+
    '<div class="mini-stats"><div class="mini-atk" style="'+statColor(m.baseId,m.isSkin,'atk',m.atk)+'">'+m.atk+'</div><div class="mini-hp" style="'+(m._peakHp&&m.hp<m._peakHp?'color:#ff4444;font-weight:900':statColor(m.baseId,m.isSkin,'hp',m.hp))+'">'+m.hp+'</div></div>'+
